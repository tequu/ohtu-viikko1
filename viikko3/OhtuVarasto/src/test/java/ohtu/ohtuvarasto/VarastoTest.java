...
public class VarastoTest {
    ...
    @Test
    public void eiOnnistutaLisaamaanLiikaa(){
    ...
    @Test
    public void negatiivisenVarastonLuontiLuoVarastonTilavuudellaNolla(){
        Varasto varasto = new Varasto(-1);
        assertEquals(0, varasto.getTilavuus(), vertailuTarkkuus);
    }
    
    @Test
    public void negatiivisenVarastonLuontiLuoVarastonTilavuudellaNollaJaSaldollaNolla(){
        Varasto varasto = new Varasto(-1, 10);
        assertEquals(0, varasto.getTilavuus(), vertailuTarkkuus);
        assertEquals(0, varasto.getSaldo(), vertailuTarkkuus);
    }
    
    @Test
    public void negatiivinenAlkuSaldoMuuttuuNollaan(){
        Varasto varasto = new Varasto(5, -1);
        assertEquals(0, varasto.getSaldo(), vertailuTarkkuus);
    }
